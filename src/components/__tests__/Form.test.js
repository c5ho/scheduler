...
describe("Form", () => {
  ...
  it("can successfully save after trying to submit an empty student name and resubmitting with name", () => {
    const onSave = jest.fn();
  ...
  it("cannot successfully save after trying to submit student name with interviewer", () => {
    const onSave = jest.fn();
    const { getByText, getByPlaceholderText, queryByText } = render(
      <Form interviewers={interviewers} onSave={onSave} />
    );
